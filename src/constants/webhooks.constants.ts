...
export const WEBHOOKS: WebhookCfg[] = [
  { id:'webhook-saudacao',                  name:'Webhook Saudação',                         url:'https://n8n-lavo-n8n.l5gxno.easypanel.host/webhook/atualiza-saudacao' },
  ...
  { id:'webhook-lista-saudacoes',           name:'Webhook Lista de Saudações',               url:'https://n8n-lavo-n8n.l5gxno.easypanel.host/webhook/salvar-lista-saudacoes' },
  ...
  { id:'webhook-agente-prospeccao-quente',  name:'Webhook Agente de Prospecção Lead Quente', url:'https://n8n-lavo-n8n.l5gxno.easypanel.host/webhook/agente-prospeccao-quente' },
  { id:'webhook-agente-prospeccao-frio',    name:'Webhook Agente de Prospecção Lead Frio',   url:'https://n8n-lavo-n8n.l5gxno.easypanel.host/webhook/agente-prospeccao-frio' },
  ...
  { id:'webhook-criar-usuario',             name:'Webhook Criar Usuário',                    url:'https://n8n-lavo-n8n.l5gxno.easypanel.host/webhook/create-user' },
  ...
  { id:'webhook-reset-password',            name:'Webhook Reset Password',                   url:'https://n8n-lavo-n8n.l5gxno.easypanel.host/webhook/reset-password' },
  { id:'webhook-atualizar-data-vencimento', name:'Webhook Atualizar Data de Vencimento',     url:'https://n8n-lavo-n8n.l5gxno.easypanel.host/webhook/update-due-date' },
  ...
  { id:'webhook-remover-ultima-base',       name:'Webhook Remover Última Base Inserida',     url:'https://n8n-lavo-n8n.l5gxno.easypanel.host/webhook/remove-last-base' },
  { id:'webhook-mercado',                   name:'Webhook Mercado (Insert Excel)',           url:'https://n8n-lavo-n8n.l5gxno.easypanel.host/webhook/mercado' },

  { id:'webhook-deletar-saudacao',          name:'Webhook Deletar Saudação',                 url:'https://n8n-lavo-n8n.l5gxno.easypanel.host/webhook/deletar-saudacao' },
  ...
  { id:'webhook-n8n-control',               name:'Webhook Controle N8N (lead-update)',       url:'https://n8n-lavo-n8n.l5gxno.easypanel.host/webhook/lead-update' },
  { id:'webhook-controle-agente',           name:'Webhook Controle do Agente',               url:'https://n8n-lavo-n8n.l5gxno.easypanel.host/webhook/controle-do-agente' },

  { id:'webhook-criar-perfil',              name:'Webhook Criar Perfil',                     url:'https://n8n-lavo-n8n.l5gxno.easypanel.host/webhook/create-profile' },
